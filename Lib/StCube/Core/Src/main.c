...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(LedFmu_GPIO_Port, LedFmu_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : LedFmu_Pin */
  GPIO_InitStruct.Pin = LedFmu_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LedFmu_GPIO_Port, &GPIO_InitStruct);
